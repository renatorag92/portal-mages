"""
Django settings for mages project.
...
SECRET_KEY = 'django-insecure-nf@_3n*_)wpvt9jmq4)z09q$xg!bbsr!pw@y5exv61v*cc%zd2'
...
WSGI_APPLICATION = 'mages.wsgi.application'
